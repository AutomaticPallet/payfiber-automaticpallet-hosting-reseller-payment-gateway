...
document.addEventListener("DOMContentLoaded", function(event) {
	addEventListener("load", function(e) {
		var PBFKey = "FLWPUBK-.............."; // replace with your payfiber public key, Get your public key from your payfiber account's dashboard
		getpaidSetup({
			PBFPubKey: PBFKey,
			...
			custom_title: "My Business Ltd", // replace with your custom tittle
